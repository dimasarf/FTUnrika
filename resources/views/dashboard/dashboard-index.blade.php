							...
							<div class="widget-summary">
								...
								<div class="widget-summary-col">
									<div class="summary">
										...
										<div class="info">
											<strong class="amount">{{$total_berita}}</strong>
							...
							<div class="widget-summary">
								...
								<div class="widget-summary-col">
									<div class="summary">
										...
										<div class="info">
											<strong class="amount">{{$total_pengumuman}}</strong>
										</div>
									</div>
									<div class="summary-footer">
							...
							<div class="widget-summary">
								...
								<div class="widget-summary-col">
									<div class="summary">
										...
										<div class="info">
											<strong class="amount">{{$total_jurnal}}</strong>
										</div>
									</div>
									<div class="summary-footer">
			...
			<section class="panel">
				...
				<!-- Morris: Donut -->
					...
					<script type="text/javascript">
						var statKonten = @json($statKonten);
